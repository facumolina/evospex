...
logging=""
cmd="java -ea $maxmem $logging -cp ${be_jar}:$mutator_bin:${project_classpath} mutator.MutateInOutObjects \"$main_class\" \"$canprop\" $numinputs $numoutputs $mutationIts swapReceivers"
